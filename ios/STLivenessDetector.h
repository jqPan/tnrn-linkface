...
extern NSTimeInterval const kDefaultTimeOutDuration;
extern CGFloat const kDefaultHacknessThresholdScore;
...
- (void)setComplexity:(LivefaceComplexity)complexity;
